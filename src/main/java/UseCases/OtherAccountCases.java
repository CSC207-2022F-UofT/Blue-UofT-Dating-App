...
/**
 * The OtherAccountCases class generates is the singular use case for OtherAccountView
 * used to retrieve data from entities for OtherAccount to display
 */
public class OtherAccountCases {
    /**
     * Gets the requested users information and sorts checks if items are to be displayed
     * or hidden
     *
     * @param userid the unique username of the user in the graph
     */
